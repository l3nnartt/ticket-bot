...
myIntents.add(Intents.FLAGS.GUILDS, Intents.FLAGS.GUILD_MEMBERS, Intents.FLAGS.GUILD_MESSAGE_REACTIONS, Intents.FLAGS.GUILD_MESSAGES);

//Partials
const myPartials = [];
myPartials.push('MESSAGE', 'GUILD_MEMBER', 'CHANNEL', 'REACTION');
